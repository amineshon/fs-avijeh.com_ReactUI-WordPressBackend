        ...
        <div className="container footer">
          <div className="row footer__row">
            <div className="col-sm-12 col-md-4 footer__adress">
              ...
              <p>
              آدرس: تهران -خیابان دکتر شریعتی-خیابان خواجه عبدالله انصاری-پلاک ۴-طبقه اول-واحد ۱
              </p>
            ...
            <div className="col-sm-12 col-md-4">
              <div>
                <ul class="footer__nav-list">
                  ...
                  <li class="footer__nav-item">
                    <a class="footer__link" href="https://fs-avijeh.com/%d9%86%d9%85%d8%a7%db%8c%d9%86%d8%af%da%af%d8%a7%d9%86">
                      نمایندگی ها
                    </a>
                  </li>
                  <li class="footer__nav-item">
