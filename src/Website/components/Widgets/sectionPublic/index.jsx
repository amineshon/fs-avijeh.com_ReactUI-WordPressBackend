    ...
    data: [
      {
        ...
        image:
          "https://fs-avijeh.com/wp-content/uploads/2021/12/milgerdBastar.png",
      },
      {
        id: 1,
        title: "گیره",
        ...
        image: "https://fs-avijeh.com/wp-content/uploads/2021/12/gire.png",
      },
      {
        id: 2,
        title: "قلاب",
        ...
        image: "https://fs-avijeh.com/wp-content/uploads/2021/12/qolab.jpg",
      },
      {
        id: 3,
        ...
        image:
          "https://fs-avijeh.com/wp-content/uploads/2021/12/MilgerdBastarTasmeei.png",
      },
      {
        id: 4,
        link:
        ...
        image:
          "https://fs-avijeh.com/wp-content/uploads/2020/08/نبشی-بالا-1-scaled.jpg",
      },
      {
        id: 5,
        link:
        ...
        image:
          "https://fs-avijeh.com/wp-content/uploads/2021/12/negahdarandeNama.png",
      },
      {
        id: 6,
        link:
        ...
        image: "https://fs-avijeh.com/wp-content/uploads/2021/12/bastRadikali.png",
      },
    ],
    productDetail: "",
  };
        ...
        <div className="col-lg-6 col-md-6">
          <div className="row">
            <div className="col-12">
              <h1 className="box-product--title">میلگرد بستر فراسازان آویژه</h1>
            </div>
            <div className="col-12">
              <div className="row">
                {data.map((item, index) => (
